...
class home extends StatelessWidget {
  ...
  const home({Key? key, required this.name, required this.school, required this.role, required this.description}) : super(key: key);
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("images/bcg.jpg"),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      CircleAvatar(
                        radius: 100.0,
                        backgroundImage: AssetImage('images/utasad.jpg'),
                      ),
                      Text(
